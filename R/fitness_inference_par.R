...
ith.Fitness <- function(phy, outFile, rho, d_t, time_scale, b_rates, d_rates, mu, T_vector, non_negativity_cutoff){
    ...
    up_messages=calc_up_messages(phy, time_scale, argument, rho, d_t, E_list, T_vector, non_negativity_cutoff)

    # down messages
    message("calculating down messages")
    down_messages=calc_down_messages(phy, time_scale, argument, rho, d_t, E_list, up_messages, T_vector, non_negativity_cutoff)
