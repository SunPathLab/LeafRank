...
#' @export
calc_up_messages <- function(phy, time_scale, argument, rho, d_t, E_list, T_vector, non_negativity_cutoff){
...
#' @export
calc_down_messages <- function(phy, time_scale, argument, rho, d_t, E_list, up_messages, T_vector, non_negativity_cutoff){
